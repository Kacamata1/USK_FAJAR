...
<style>
    ...
    .card-cart .text-card a.cart-edit{
        background: #FF6000;
        color: #fff;
        padding: 10px;
        text-decoration: none;
    ...
    .card-cart .text-card a.cart-edit:hover{
        background: #FF8400;
        color: #fff;
        transition: 0.3s;
    }
    ...
    .checkout-card a.checkout:hover{
        background: #326792;
        color: #fff;
        transition: 0.3s;
    }
    ...
    <?php foreach ($_SESSION["cart"] as $id_produk => $hasil) : ?>
        ...
        <div class="card-cart">
            ...
            <div class="text-card">
                ...
                <a href="edit.php?id=<?= $data["id_produk"]; ?>" class="cart-edit">Edit</a>
            </div><br><hr>
        </div>
            <?php endforeach; ?>
</div>